...
public class QProductIo extends EntityPathBase<ProductIo> {
    ...
    private static final long serialVersionUID = -1338545933L;
    ...
    public final com.lookfit.order.domain.QBuy buy;
    ...
    public QProductIo(Class<? extends ProductIo> type, PathMetadata metadata, PathInits inits) {
        ...
        this.buy = inits.isInitialized("buy") ? new com.lookfit.order.domain.QBuy(forProperty("buy"), inits.get("buy")) : null;
